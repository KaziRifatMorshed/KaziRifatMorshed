...
[![My Skills](https://skillicons.dev/icons?i=c,cpp,qt,java,py,markdown,obsidian,linux,arch,latex,mysql,html,css,git,github,gitlab,bash,php,ai,anaconda,arduino,matlab,octave,sqlite&theme=light)](https://skillicons.dev)
